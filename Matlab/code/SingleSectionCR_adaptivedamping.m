function SingleSectionCR_adaptivedamping(Force,length,resolution,timesteps, crosssectionradius, youngsmodulus)
% damping increases as force increases
    %clc;
    ...
    Bbt = 1e-6*eye(3)*1.9 * (0.5*L/r);   % silicone rubber
    Bbtinitial = Bbt;
